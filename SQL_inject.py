# SQL Injection on Oracle Database
import requests
import sys
import urllib3
...
# So it can proxy through Burp
proxies = {'http': 'http://127.0.0.1:8080', 'https': 'https:127.0.0.1:8080'}

# Using the UNION to include multiple queries
# sending get request to the exploit SQL version URL with its path, payload, and proxy...
# if oracle database in response, parse the response to output the database and its version
